# web_data_app.py
# Modified by: Arman Hosseinsarraf
#
...
def book_data():
    ...
    book_results = soup.find_all(
        attrs={'class': 'product_pod'})  # By inspecting the site, we know books = product_pod class
...
def learn():
    ...
    result = "In ENSF-592 I have learned 'Much to learn still low'"
    return result
